...
{
    CHKERR1(agent);
    CACE_LOG_DEBUG("Registering ADM: " "ietf-amm-base");
    ...
    if (adm)
    {
        ...
        { // For ./IDENT/display-hint
            ...
            obj = refda_register_ident(adm, cace_amm_idseg_ref_withenum("display-hint", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_IDENT_DISPLAY_HINT), objdata);
            // no parameters
        }
        { // For ./IDENT/display-hint-integer
            ...
            obj = refda_register_ident(adm, cace_amm_idseg_ref_withenum("display-hint-integer", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_IDENT_DISPLAY_HINT_INTEGER), objdata);
            // no parameters
        }
        { // For ./IDENT/display-hint-float
            ...
            obj = refda_register_ident(adm, cace_amm_idseg_ref_withenum("display-hint-float", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_IDENT_DISPLAY_HINT_FLOAT), objdata);
            // no parameters
        }
        { // For ./IDENT/display-hint-bstr
            ...
            obj = refda_register_ident(adm, cace_amm_idseg_ref_withenum("display-hint-bstr", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_IDENT_DISPLAY_HINT_BSTR), objdata);
            // no parameters
        }
        { // For ./IDENT/display-hint-time
            ...
            obj = refda_register_ident(adm, cace_amm_idseg_ref_withenum("display-hint-time", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_IDENT_DISPLAY_HINT_TIME), objdata);
            // no parameters
        }
        { // For ./IDENT/bstr-ari-pattern
            ...
            obj = refda_register_ident(adm, cace_amm_idseg_ref_withenum("bstr-ari-pattern", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_IDENT_BSTR_ARI_PATTERN), objdata);
            // no parameters
        }
        ...
        { // For ./TYPEDEF/type-ref
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("type-ref", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_TYPE_REF), objdata);
        ...
        { // For ./TYPEDEF/integer
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("integer", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_INTEGER), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/float
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("float", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_FLOAT), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/numeric
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("numeric", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_NUMERIC), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/primitive
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("primitive", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_PRIMITIVE), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/time
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("time", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_TIME), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/simple
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("simple", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_SIMPLE), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/nested
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("nested", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_NESTED), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/any
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("any", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_ANY), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/value-obj
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("value-obj", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_VALUE_OBJ), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/nonce
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("nonce", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_NONCE), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/id-text
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            // named semantic type:
            {
                ...
                cace_amm_semtype_cnst_t *cnst;
                {
                    ...
                    cnst = cace_amm_semtype_cnst_array_push_new(((cace_amm_semtype_use_t *)(&(objdata->typeobj))->as_semtype)->constraints);
        ...
        { // For ./TYPEDEF/counter32
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("counter32", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_COUNTER32), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/counter64
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("counter64", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_COUNTER64), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/gauge32
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("gauge32", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_GAUGE32), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/gauge64
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("gauge64", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_GAUGE64), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/timestamp
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("timestamp", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_TIMESTAMP), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/eval-tgt
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("eval-tgt", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_EVAL_TGT), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/expr-item
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("expr-item", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_EXPR_ITEM), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/expr
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("expr", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_EXPR), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/exec-tgt
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("exec-tgt", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_EXEC_TGT), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/exec-item
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("exec-item", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_EXEC_ITEM), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/mac
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("mac", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_MAC), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/rpt-tgt
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("rpt-tgt", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_RPT_TGT), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/rptt-item
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("rptt-item", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_RPTT_ITEM), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/rptt
            refda_amm_typedef_desc_t *objdata = CACE_MALLOC(sizeof(refda_amm_typedef_desc_t));
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("rptt", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_RPTT), objdata);
            // no parameters possible
        }
        { // For ./TYPEDEF/ari-pattern
            ...
            obj = refda_register_typedef(adm, cace_amm_idseg_ref_withenum("ari-pattern", REFDA_ADM_IETF_AMM_BASE_ENUM_OBJID_TYPEDEF_ARI_PATTERN), objdata);
            // no parameters possible
        }
    }
